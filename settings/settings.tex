...
%\usepackage{natbib}
%\usepackage[style=phys, sorting=none,backend=bibtex]{biblatex}
\usepackage[style=phys,articletitle=true,biblabel=brackets,chaptertitle=true,pageranges=true,maxbibnames=99]{biblatex}
\makeatletter
...
\setcounter{secnumdepth}{5} %5 avant
...
\usepackage{csquotes}
\usepackage[style=super,nopostdot,nonumberlist]{glossaries}
%if you want to display the page number, delete nonumberlist
\makeglossaries
\input{01_head/abbreviations.tex}
