...
Lau and Lubensky \cite{lau_state-dependent_2007} derived an exact solution to Eq.~(\ref{Eq.toy}) as:

\begin{equation}
	P(z,t) = \frac{1}{k_\mathrm{B}T} \frac{F}{1 - \mathrm{e}^{-\frac{Ft}{ak_\mathrm{B}T}}}
\end{equation}
