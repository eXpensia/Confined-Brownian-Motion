...
\begin{equation}
	\textnormal{d}x = u(X_t) \textnormal{d}t + \zeta(X_t)\textnormal{d}B_t ~,
	\label{SDE2}
\end{equation}
...
\begin{equation}
	\langle f(x) \rangle = \int \textnormal{d}X_t ~ P(X_t, X_0 ; t) f(X_t) ~,
	\label{fokker1}
\end{equation}
