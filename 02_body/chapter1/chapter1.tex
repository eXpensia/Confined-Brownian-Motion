...
\begin{equation}
	mdV_t  = - \gamma V_t \textnormal{d}t + \alpha \textnormal{d}tB_t ~,
\end{equation}
...
\begin{equation}
	\langle dV_t \rangle = - \frac{\gamma}{m} \langle V_t \rangle \textnormal{d}t + \frac{\alpha}{m} \langle dB_t \rangle ~,
	\label{Eq.langevinsd}
\end{equation}
...
\begin{equation}
	\langle dV_t \rangle = - \frac{\gamma}{m} \langle V_t \rangle \textnormal{d}t ~,
\end{equation}
