...
\begin{equation}
	\left\langle  \frac{ \textnormal{d}V_t}{\textnormal{d}t} \right\rangle = - \frac{\gamma}{m} \langle V_t \rangle \textnormal{d}t  + \frac{\alpha}{m} \langle  \textnormal{d}B_t \rangle ~,
	\label{Eq.langevinsd}
\end{equation}
